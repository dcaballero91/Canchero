...
public final class FrmMantenimientoAtendida extends javax.swing.JFrame {
    ...
    private void jtFichasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtFichasMouseClicked
        ...
        try {
            PreConsulta fic;
            fic = BDPreConsulta.buscarPreConsulta(Integer.parseInt(String.valueOf(jtFichas.getModel().getValueAt(jtFichas.getSelectedRow(),0))));
    ...
    private void actualizarBusqueda() {
        ...
        if (String.valueOf(cboParametroProv.getSelectedItem()).equalsIgnoreCase("Año")) {
           ...
           result = BDPreConsulta.listarPreConsultaPorNombre(txtBuscarProv.getText());
        } else if (String.valueOf(cboParametroProv.getSelectedItem()).equalsIgnoreCase("NFicha")) {
           result = BDPreConsulta.listarPreConsultaPorCodigo(txtBuscarProv.getText());
        }
