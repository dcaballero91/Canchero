...
public class JDBuscarSMS extends javax.swing.JDialog {

    private final FrmMenuPrincipal JDBListaS;
     ...
     * @param FrmMP
     */
    public JDBuscarSMS(java.awt.Frame parent, boolean modal, final FrmMenuPrincipal JDBListaS) {
        super(parent, modal);
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        cboParametroPro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Numero", "Fecha", " " }));
    ...
    private void actualizarBusqueda() {
        ...
        if (String.valueOf(cboParametroPro.getSelectedItem()).equalsIgnoreCase("Numero")) {
            result = BDSMS.listarSMSporNumero(txtBuscarPro.getText());

        } else if (String.valueOf(cboParametroPro.getSelectedItem()).equalsIgnoreCase("Fecha")) {
            result = BDSMS.listarSMSPorFecha(txtBuscarPro.getText());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDBuscarSMS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JDBuscarSMS dialog = new JDBuscarSMS(new javax.swing.JFrame(), true, null);
